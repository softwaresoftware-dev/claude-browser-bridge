...
1. Call `daemon_start("claude-browser-bridge", "node", ["dist/daemon.cjs"], cwd="/home/thatcher/projects/nov/projects/mcps/claude-browser-bridge")` using the daemon-manager tool
